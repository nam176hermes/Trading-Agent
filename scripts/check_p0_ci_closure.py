            ...
            (
                {
                    ...
                    "run": 'uv run python scripts/qualify_pre_p3.py promotion-v1 --candidate docs/implementation/pre-p3/receipts/pre-p3-candidate-v2.json --promoted-revision "$GITHUB_SHA" --output "${RUNNER_TEMP:?}/pre-p3-promotion/${GITHUB_SHA}-v1.json"',
                },
                {},
            ),
            (
