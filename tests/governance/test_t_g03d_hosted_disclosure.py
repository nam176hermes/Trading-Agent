...
def _recursive_make_projection_spans(source: str) -> list[tuple[int, int]]:
    ...
    approved_forms = {
        ...
        ("ci-portable-private", ("ci-common-private", "ci-portable-topology", "check-portable-defect-closure", "check-p0-baseline", "check-p0-maintainability", "check-p1-nautilus-boundaries", "check-p1-nautilus-lineage", "check-p1-nautilus-pin-inventory", "check-test-governance-topology", "check-p0-ci-closure", "artifact-firewall-check", "audit-delivery-contract")),
    ...
    with tempfile.TemporaryDirectory(dir="/tmp") as raw:
        ...
        expected = [
            ...
            ("ci-portable-topology", ("uv", "run", "python", "-m", "scripts.t_g03_capability_topology", "reserve", *topology)), ("ci-portable-topology", ("uv", "run", "python", "-m", "scripts.t_g03_capability_topology", "check-closure", *topology)), ("ci-portable-topology", ("uv", "run", "python", "-m", "scripts.t_g03_capability_topology", "run-lane", "--lane", "native-capabilities", *topology)), ("ci-portable-topology", ("uv", "run", "python", "-m", "scripts.t_g03_capability_topology", "run-lane", "--lane", "external-authorities", *topology)), ("ci-portable-topology", ("uv", "run", "python", "-m", "scripts.t_g03_capability_topology", "aggregate", *topology)),
                ("check-portable-defect-closure", ("uv", "run", "python", "-m", "scripts.t_g03_capability_topology", "validate-closure", *topology)),
