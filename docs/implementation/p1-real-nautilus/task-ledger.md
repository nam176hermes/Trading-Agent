...
| P1-25 | P1-23, P1-24 | ACCEPTED | Exact `080a0786…/81ebb5c1…` schema-8 E2E, adversarial and portable gates plus independent spec/security reviews passed; remote `P1_A_COMPLETE` is certified by integrated source `9444a008…/a083bf46…` and protected Foundation run `33348201903`. |
...
| P1-30 | P1-29 | ACCEPTED | Exact G1/schema-8 local-paper qualification passed 69 tests with zero skips and independent reviews found zero Critical/Important issues. Authorized integration source `9444a008…/a083bf46…` passed protected Foundation run `33348201903`; `P1_COMPLETE` is certified while network/live/production authority remains false. |
