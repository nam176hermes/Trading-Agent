...
| P1-U04 | P1-U03 | U04_SOURCE_ACCEPTED | Complete the external/native authority preflight when supplied. |
...
The terminal current outcome is `P1_U04_SOURCE_READY_NATIVE_DEFERRED`: this is
not COMPLETE and grants no U05 or promotion authority.
