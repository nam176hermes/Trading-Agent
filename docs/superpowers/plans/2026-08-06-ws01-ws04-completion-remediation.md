...
- [ ] **Step 3: Verify every sealed private input and the external artifact.**
  - Run `python3.11 -I scripts/prepare_nautilus_toolchain.py --manifest engines/nautilus/toolchain-inputs.json --cache /home/thenam176/.cache/trading-agent/nautilus/rust-downloads --destination /home/thenam176/.cache/trading-agent/nautilus/rust-1.95.0 --verify-materialized`. This read-only path must pass; do not use `--acquire` or `--materialize`.
  - Run `python3.11 -I scripts/prepare_nautilus_llvm_toolchain.py --policy engines/nautilus/llvm-toolchain-policy.json --cache /home/thenam176/.cache/trading-agent/nautilus/llvm-22.1.3-resource-cache --destination /home/thenam176/.cache/trading-agent/nautilus/llvm-22.1.3-resource-toolchain --verify-cache`, then repeat with `--verify-toolchain`.
  - Run `sha256sum /home/thenam176/.cache/trading-agent/nautilus/wheel-cache/wheel-cache-manifest.json`, copy the printed digest literally, then run `python3.11 -I scripts/prepare_nautilus_wheel_cache.py --policy engines/nautilus/wheel-cache-policy.json --engine-policy engines/nautilus/engine-build-policy.json --cache /home/thenam176/.cache/trading-agent/nautilus/wheel-cache --verify --manifest-sha256 0a7693f27a384925698dde2818abd70b894524bae341a62de0ef8f17500d108b` only if the copied digest matches that value.
  - Run `python3.11 -I scripts/build_nautilus_engine.py --policy engines/nautilus/engine-build-policy.json --python /home/thenam176/.cache/trading-agent/nautilus/runtime-closure-v3/files/usr/bin/python3.12 --artifacts /home/thenam176/.cache/trading-agent/nautilus/artifacts/nautilus-1.227.0-cp312-rust-bound --verify --verify-input-bindings --offline --input-cache /home/thenam176/.cache/trading-agent/nautilus/input-cache --wheel-cache /home/thenam176/.cache/trading-agent/nautilus/wheel-cache --wheel-cache-manifest-sha256 0a7693f27a384925698dde2818abd70b894524bae341a62de0ef8f17500d108b --cargo /home/thenam176/.cache/trading-agent/nautilus/rust-1.95.0/bin/cargo --llvm-toolchain /home/thenam176/.cache/trading-agent/nautilus/llvm-22.1.3-resource-toolchain --sandbox /usr/bin/bwrap`.
