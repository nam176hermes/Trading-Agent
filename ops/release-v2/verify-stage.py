...
_PAPER_APPLICATION_SOURCE_MAPPING = {
    ...
    'packages/runtime_release/paper_application/domain_init.py': 'packages/domain/__init__.py',
    ...
    'packages/runtime_release/paper_application/engine_contracts_init.py': 'packages/engine_contracts/__init__.py',
    'packages/engine_contracts/commands.py': 'packages/engine_contracts/commands.py',
    'packages/engine_contracts/envelopes.py': 'packages/engine_contracts/envelopes.py',
    'packages/engine_contracts/events.py': 'packages/engine_contracts/events.py',
    'packages/engine_contracts/serialization.py': 'packages/engine_contracts/serialization.py',
    'packages/engine_contracts/versions.py': 'packages/engine_contracts/versions.py',
    'packages/engine_event_ledger/__init__.py': 'packages/engine_event_ledger/__init__.py',
    'packages/engine_event_ledger/errors.py': 'packages/engine_event_ledger/errors.py',
    'packages/engine_event_ledger/models.py': 'packages/engine_event_ledger/models.py',
    'packages/engine_event_ledger/replay.py': 'packages/engine_event_ledger/replay.py',
    ...
    'services/job_store/engine_event_repository.py': 'services/job_store/engine_event_repository.py',
    ...
    'services/job_worker/engine_authority.py': 'services/job_worker/engine_authority.py',
    'services/job_worker/engine_results.py': 'services/job_worker/engine_results.py',
