    ...
    *,
    ...
    for index, item in enumerate(math):
        payload = {
            ...
            "return_end_at": values[index].closed_at,
    ...
    payload = {
        ...
        "raw_signal_digest": hashlib.sha256(canonical_json_bytes(weights)).hexdigest(),
        "effective_weights_digest": hashlib.sha256(canonical_json_bytes(weights)).hexdigest(),
