...
class ResultValidator:
    ...
    def __init__(self, reports_root: Path, replay_root: Path, artifact_root: Path | None = None) -> None:
        ...
        _ = replay_root  # positional compatibility only; replay is not packaged
        self._artifact_root = (
            Path(artifact_root)
    ...
    def validate(
        ...
        if (
            ...
            raise ResultValidationError("spawn-bound semantic input fingerprint is invalid")
...
__all__ = [
    "MAX_REPORT_ASSETS", "MAX_RESULT_BYTES", "MAX_RESULT_CANDIDATES",
